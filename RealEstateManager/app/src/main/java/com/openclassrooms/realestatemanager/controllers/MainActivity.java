...
//    String TAG = MainActivity.this.getClass().getSimpleName();
    ...
    private void setupRealEstateDetailFragmentAndShow() {
        ...
        if (idRealEstateSelected > 0) {
            realEstateViewModel.getRealEstateById(idRealEstateSelected).observe(this, realEstate -> realEstateViewModel.getRealEstateImages(realEstate).observe(this, images -> realEstateDetailFragment.setRealEstate(realEstate, images)));
